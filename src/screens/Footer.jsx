...
export default function Footer() {
  ...
  return (
    <>
      <div className="footer w-full h-max mt-28 flex flex-col lg:flex-row md:gap-8 lg:gap-8 px-10 md:px-36 lg:px-10 xl:px-14 py-20 text-white text-center lg:text-start">
      ...
      <p className="text-white text-center">Mellisai@copyright 2024-2030</p>
    </>
  );
}
